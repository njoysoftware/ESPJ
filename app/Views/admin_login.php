                        ...
                        <div class="col-lg-5">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header bg-primary">
                                    <h3 class="text-center font-weight-light my-4"><i class="fas fa-sun"></i> E-SPJ Administrator</h3>
                                </div>
                                <div class="card-body">
                                    <form method="post" action="/nzr_admin/admin_auth" name="loginForm">
            ...
            <footer class="py-4 bg-light mt-auto">
                <div class="container-fluid px-4">
                    <div class="d-flex align-items-center justify-content-between small">
                        <div class="text-muted">Copyright &copy; Nizar 2025</div>
                        <div>
                            <a href="/">Bawaslu</a>
                        </div>
                    </div>
